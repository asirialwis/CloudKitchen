...
class NotificationService {
  async sendOrderConfirmation(userId, orderDetails) {
    try {
      ...
      if (!mongoose.Types.ObjectId.isValid(orderDetails._id)) {
      ...
      await this._logFailedNotification(
        ...
        orderDetails && mongoose.Types.ObjectId.isValid(orderDetails._id)
          ? orderDetails._id
          : null,
        error
      );
      ...
      <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #eaeaea; border-radius: 8px; overflow: hidden;">
        ...
        <div style="padding: 20px;">
          ...
          <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
            ...
            <tfoot>
              <tr>
                ...
                <td style="text-align: right; padding: 10px; font-weight: bold;">Rs. ${order.totalAmount.toFixed(
                  2
                )}</td>
              </tr>
            </tfoot>
          ...
          <p style="font-size: 16px;">
            We appreciate your choice and hope you enjoy your meal!<br>
  ...
  async _logFailedNotification(userId, orderId, error) {
    ...
    await Notification.create({
      ...
      type: "email",
      status: "failed",
      content: String(error.message).substring(0, 500), // prevent injection/log abuse
    });
  }
}
